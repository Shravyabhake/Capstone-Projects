...
public class LoginorhmTest {  
    ...
    public void Ohrmlogin(String un, String ps) throws InterruptedException {  
      ...
      //  driver.findElement(By.name("password")).clear();  
        ...
        if (currentUrl.contains("dashboard")) {  
            ...
            Thread.sleep(2000);  
            driver.get("https://opensource-demo.orangehrmlive.com/web/index.php/auth/login"); // back to login page  
        } else {  
        	
        	
            Utility.getScreenshot(driver);  
            System.out.println("Login failed for: " + un);  
           // driver.get("https://opensource-demo.orangehrmlive.com/web/index.php/auth/login"); // reset state  
    ...
    public void afterTest() throws IOException {  
        ...
        fis.close();  
        report.flush();  
        driver.quit();  // close browser only once  
    }  
}
